...
public class QuizApplication implements CommandLineRunner {
    ...
    @Autowired
    public QuizApplication(TestManager manager, QuestionFactory factory, Scanner scanner) {
    ...
    private void addQuestion() {
        ...
        if (getIntInput(1, 2) == 1) {
            ...
            question = new com.example.quiz.model.HintDecorator(question, scanner.nextLine());
        }
